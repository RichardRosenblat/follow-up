...
describe("Find by id story use case", () => {
    ...
    it("Should return an story by id when the execute method is called", async () => {
    ...
    it("Should return an falsy value when the execute method is called with an inexistent id", async () => {
